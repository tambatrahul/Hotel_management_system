...
<body style="background-color: #090806;"> 
    
<div id="footer" class="w-100" style="background-color: #090806; position:relative; bottom:-20px;">
			<button id="buttons" onclick="window.location.href='user/user.php'" class="btn btn-secondary border mr-2 ml-2"><i class="fas fa-users"></i> Dine In</button>
			<button id="buttons" onclick="window.location.href='products/products.php'" class="btn btn-secondary border mr-2"><i class="fas fa-box-open"></i> Tablet</button>
			<button id="buttons" onclick="window.location.href='supplier/supplier.php'" class="btn btn-secondary border mr-2"><i class="fas fa-user-tie"></i> My Orders</button>
			<button id="buttons" onclick="window.location.href='customer/customer.php'" class="btn btn-secondary border mr-2"><i class="fas fa-user-friends"></i> Dashboard</button>
        ...
        <br>
	<div class="h-100 bg" style="background-color: #090806;" id="container">
		...
		if (mysqli_num_rows($result) > 0){
            ...
            <div class="header_price border p-0"style="height:40px;width:100px;position: relative;left: 700px;top:-80px;">
				
				<p class="pb-0 mr-2" style=" font-size: 20px;" id="totalValue">Rs. <?php echo $totalv?>.00</p>
			</div>
		</div>
		<div id="sidebar">
  ...
  top:-90px;">
		...
		<button id="buttons" type="button" name='save' class="Save btn btn-secondary border mr-2 ml-2"><i class="fas fa-handshake"></i> Save</button>
        <button id="buttons" name="logout" type="button" onclick="out();" class="logout btn btn-danger border mr-2"><i class="fas fa-sign-out-alt"></i> Logout</button> 
		</div>
	</div>
	<?php include('add.php');?>
